...
//                 value={roomId}
//                 readOnly
//                 className="flex-1 min-w-[150px] px-4 py-2 bg-gray-800 text-white border border-gray-700 rounded focus:outline-none"
//               />
//               <button
//                 type="button"
//                 onClick={() => {
...
//               >
//                 {generateUId?<span className="text-green-400 font-semibold">Generated!</span>:<span>Generate</span>}
//               </button>
//               <button
//                 type="button"
...
//               >
//                 {copied?<span className="text-green-400 font-semibold">Copied!</span>:<span>Copy</span>}
//               </button>
...
const JoinCreateRoom = ({ socket, setUser }) => {
  ...
  const handleCreateRoom = (e) => {
    ...
    const roomData = {
      ...
      host: true,
      presenter: true,
      friendsAccess: accessType  // This will be used to assign roles when others join
    };

    // Store access type in localStorage to read during joining
  ...
  const handleJoinRoom = (e) => {
    ...
    const roomData = {
      ...
      userId: uuidv4(),
      host: false,
      presenter: access === "edit" // 👈 Automatically assigned
    };
